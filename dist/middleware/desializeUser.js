    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = (0, jwt_utils_1.verifyJwt)(accessToken), decoded = _a.decoded, expired = _a.expired;
                if (decoded) {
                    res.locals.user = decoded;
                    return [2 /*return*/, next()];
                }
                if (!(expired && refreshToken)) return [3 /*break*/, 2];
                return [4 /*yield*/, (0, session_controller_1.reIssueAccessToken)({ refreshToken: refreshToken })];
            case 1:
                newAccessToken = _b.sent();
                (0, logger_1.default)("expired");
                if (newAccessToken) {
                    res.setHeader("x-access-token", newAccessToken);
                }
                result = (0, jwt_utils_1.verifyJwt)(newAccessToken);
                return [2 /*return*/, next()];
...
//# sourceMappingURL=desializeUser.js.map